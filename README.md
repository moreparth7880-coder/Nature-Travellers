...
2. Interactive Navigation Bar:
    ...
    Shrinks while scrolling for better viewing experience.

3. Smooth Scrolling Navigation:
   
    Allows users to smoothly scroll between sections like About, Places, and Contact.

4. Attractive Destination Showcase:
   
    Displays beautiful travel destinations with images.
   
    Highlights natural places such as mountains, forests, beaches, and deserts.

5. Informative Content:
    
    Provides information about travelling and its benefits
   
    Encourages users to explore nature and different destinations
